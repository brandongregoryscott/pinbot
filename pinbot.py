...
BOT_ID = os.getenv("BOT_ID", 'U2WBND3L5')
SLACK_BOT_TOKEN = os.getenv("SLACK_BOT_TOKEN", 'xoxb-98396445685-gexbnAI5UoqHXh9vSAQkjsIW')
...
def post_train(command, channel):
    ...
    # next, we generate a random number between 1 and 10, and append the emoji that many times to the tail of the string
    # this algorithm appends an emoji onto the end of the post_text, which begins with the ":train:" emoji and gets an
    # and gets an emoji for every iteration of i
